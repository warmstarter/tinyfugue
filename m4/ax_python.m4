...
AC_MSG_RESULT([])
#for python in python3 python3.10 python3.9 python3.8 python3.7 python3.6 python3.5 python3.4 python3.3 python3.2 python3.1 python3.0 python2 python2.7 python2.6 python2.5 python2.4 python2.3 python2.2 python2.1 python; do
for python in python python2.7 python2.5 python2.4 python2.3 python2.2. python2.1 python; do
